...
var video3 = document.querySelector('.video-three');

var aptoBtn = document.getElementById('apto');
var aptoBtn_active = document.getElementById('apto__active');
var interstialBtn = document.getElementById('interstial');
var interstialBtn_active = document.getElementById('interstial__active');
var swipeCubeWebBtn = document.getElementById('swipeCubeWeb');
var swipeCubeWebBtn_active = document.getElementById('swipeCubeWeb__active');
...
if(randomValue == 0) {
  ...
  aptoBtn.style.display = 'none';
  aptoBtn_active.style.display = 'block';

  // aptoBtn.style.background = "linear-gradient(41deg, rgb(243 202 199), rgb(125 145 171))";
  // interstialBtn.style.background = "linear-gradient(41deg, #ffffff, #ffffff)";
  // swipeCubeWebBtn.style.background = "linear-gradient(41deg, #ffffff, #ffffff)";
  ...
  interstialBtn.style.display = 'none';
  interstialBtn_active.style.display = 'block';
  // aptoBtn.style.background = "linear-gradient(41deg, #ffffff, #ffffff)";
  // interstialBtn.style.background = "linear-gradient(41deg, rgb(243 202 199), rgb(125 145 171))";
  // swipeCubeWebBtn.style.background = "linear-gradient(41deg, #ffffff, #ffffff)";
  ...
  swipeCubeWebBtn.style.display = 'none';
  swipeCubeWebBtn_active.style.display = 'block';
  // aptoBtn.style.background = "linear-gradient(41deg, #ffffff, #ffffff)";
  // interstialBtn.style.background = "linear-gradient(41deg, #ffffff, #ffffff)";
  // swipeCubeWebBtn.style.background = "linear-gradient(41deg, rgb(243 202 199), rgb(125 145 171))";
...
// Weborama Devices
    ...
    let apto_active = document.getElementById('apto__active');
    let interstial_active = document.getElementById('interstial__active');
    let swipeCubeWeb_active = document.getElementById('swipeCubeWeb__active');
    ...
    apto.addEventListener('click', function() {
      ...
      apto_active.style.display = 'block';

      interstial.style.display = 'block';
      interstial_active.style.display = 'none';

      swipeCubeWeb.style.display = 'block';
      swipeCubeWeb_active.style.display = 'none';
    ...
    interstial.addEventListener('click', function() {
      ...
      apto.style.display = 'block';
      apto_active.style.display = 'none';

      interstial.style.display = 'none';
      interstial_active.style.display = 'block';
    ...
    swipeCubeWeb.addEventListener('click', function() {
      ...
      swipeCubeWeb.style.display = 'none';
      swipeCubeWeb_active.style.display = 'block';
